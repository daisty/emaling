<template>
  <transition name="fade-in">  
    <div class="fix-box" :style="zIndex" v-show="fixedOption.brokerageShow">
      <div class="content" :style="wh" v-show="fixedOption.brokerageShow">
        <div class="fix-top" :style="backgroundColor">
          <span class="text">经手人选择</span>
          <b class="close" @click="fixedOption.brokerageShow=false">×</b>
        </div>
        <div class="fix-content">
          <div class="search">
            <div class="input">
              <el-input size="mini" v-model="userName" placeholder="请输入经手人名称/编号查询"></el-input>
            </div>
            <el-button size="mini">查询</el-button>
            <el-button style="float:right" size="mini" @click="eve"><i class="el-icon-plus"></i>新增</el-button>
          </div>
          <brokerage-table @someInfo="getInfo" :tableData="tableData.list"></brokerage-table>
          <this-url></this-url>
...
export default {
  ...
  methods: {
    ...
    sureChose() {
      ...
      this.$emit("handlerInfl", {
        name: this.tableData.list[this.index].userName,
        id: this.tableData.list[this.index].userId
      });
      this.fixedOption.brokerageShow = false;
    },
    cancle() {
      this.index = "";
      this.fixedOption.brokerageShow = false;
