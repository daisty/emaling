<template>
  <div class="table-contain">
    <el-table style="width: 100%;height:calc100%" height="100%" :data="data" :summary-method="getSummaries" v-loading.body="tableLoading" element-loading-text="加载中..." border fit highlight-current-row show-summary>
      ...
      <el-table-column prop="goodsNo" label="编号" width="180"></el-table-column>
      ...
      <el-table-column prop="itemCount" label="条数"></el-table-column>
      <el-table-column prop="orderQuantity" label="入库数量"></el-table-column>
...
export default {
  ...
  methods: {
    getSummaries (param) {
      ...
      sums[7] = sums[7] ? sums[7].toFixed(2) : 0
      sums[8] = '米'
      return sums
    }
  },
