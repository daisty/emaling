<template>
	<div class="app-container" v-loading="loading">
		...
		<div class="btn-contain">
			<el-button type="primary" size="mini" @click="update">更新草稿</el-button>
			<el-button type="primary" size="mini">申请调拨</el-button>
		</div>
...
<script>
import { fetchstockAllotContent,updateAllotDraft } from "@/api/inventory";
				...
				return new Promise((resolve, reject) => {
					fetchstockAllotContent(urlId).then(response=>{
						if (response.code === 0) {
							...
							_self.queryData.handlerUserId = data.handlerUserId;
							...
							_self.queryData.stockAllotId = data.stockAllotId;
							_self.queryData.storeNo = data.storeNo;
							_self.queryData.storeId = data.storeId;
							_self.queryData.targetStoreId = data.targetStoreId;
							_self.queryData.targetStoreNo = data.targetStoreNo;
...
//	      弹层方法
		   ...
		   getDeport(){
		    ...
		    update(){
		    		...
		    		return new Promise((resolve,reject)=>{
		    			updateAllotDraft(this.queryData).then(response=>{
