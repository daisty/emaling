<template>
  ...
  <div class="app-container">
    ...
    <search-box v-if="requestData.supplierName" :defaultSearchData="requestData" :searchOption="searchOption" :comChange="searchOnChange" ref="search" :disabled="true"></search-box>
    <!-- :query="query" -->
    <input-table :trConfig="trConfig" :data="requestData.purchaseGoodsList" :summaryMethod="summaryMethod" :disabled="true"></input-table>
    <el-input placeholder="单据备注" v-model="requestData.remark" :disabled="true"></el-input>
