  ...
  <div class="app-container">
    ...
    <div class="table-contain">
      <el-table style="width: 100%;height:100%"
        ...
        <el-table-column label="操作" width="80">
          <template slot-scope="scope">
            <div class="scope-flex">
              <el-button class="flex-btn" @click="handleUpdate(scope.row)" type="text" size="small">修改</el-button>
              <el-button class="flex-btn" @click="handleDelete(scope.row)" type="text" size="small">复制</el-button>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="type" label="记账状态" >
          <template slot-scope="scope">
        ...
        <el-table-column prop="suppiler" label="供应商" ></el-table-column>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableData: [
          ...
          { billDate: new Date(), billNum: 'CGRKD-20180417-0006', billStatus: 113, accountStatus: 222, totalCount: 3, totalColor: 2, totalStockIn: 223.69, unit: '米', inventory: '中大仓库', suppiler: 'A', handler: 'Kalvin', remark: '赶紧发货' },
          { billDate: new Date(), billNum: 'CGRKD-20180417-0007', billStatus: 114, accountStatus: 222, totalCount: 3, totalColor: 2, totalStockIn: 223.69, unit: '米', inventory: '中大仓库', suppiler: 'A', handler: 'Kalvin', remark: '赶紧发货' },
    ...
    methods: {
      goHistory(val) {
        switch (val) {
          case 112:
            this.$router.push('return_bill_cancel')
            break
          case 113:
            this.$router.push('return_bill_draft')
            break
          case 114:
            this.$router.push('stock_bill_done')
            break
          default:
            break
        }
