  ...
  <div class="app-container" v-loading="loading">
    ...
    <div class="table-contain">
      <el-table style="width:100%;"
        ...
        <el-table-column label="操作" width="120">
          <template slot-scope="scope" class="flex-doing">
            <div class="scope-flex">
              ...
              <span class="blue" @click="handleDeleteAccount(scope.$index)">删除</span>
        ...
        <el-table-column prop="bankName" label="银行全称" width="220">
          <template slot-scope="scope">
            <span v-text="scope.row.bankName"></span>
          </template>
        </el-table-column>
        <el-table-column prop="myCode" label="助记码">
          <template slot-scope="scope">
            <span v-text="scope.row.myCode"></span>
          </template>
        </el-table-column>
        <el-table-column prop="bankAccountName" label="开户名" width="220">
          <template slot-scope="scope">
            <span v-text="scope.row.bankAccountName"></span>
          </template>
        </el-table-column>
        <el-table-column prop="bankSubName" label="开户行" width="230">
          <template slot-scope="scope">
            <span v-text="scope.row.bankSubName"></span>
          </template>
        </el-table-column>
        <el-table-column prop="bankAccount" label="银行账号" width="230">
          <template slot-scope="scope">
