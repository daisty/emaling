...
<template>
  <div>
    <el-dialog title="商品分类" :visible.sync="dialogVisible" size="tiny" :before-close="handleClose">
      ...
      <el-button size="small" type="primary" @click="categoryNameAdd">确 定</el-button>
      </span>
    </el-dialog>
    <el-dialog
        title="编辑商品"
        ...
        fetchGetCommodityDetail(sessionStorage.getItem("goodsId"))
          .then(response => {
            if (response.data.code === 0) {
              ...
              this.form.gramWeight = goods.gramWeight
              this.form.ingredient = goods.ingredient
              this.form.width = goods.width
