...
<template>
  <div>
    <el-dialog title="单位编辑" :visible.sync="dialogVisible" size="tiny" :before-close="handleClose" width="600px">
...
export default {
  ...
  mounted() {
    const op = this.$route.query;
      ...
      this.form.unitId = op.row.unitId;
      this.form.unitName = op.row.unitName;
      this.form.pinYin = op.row.pinYin; 
