<template>
  <div class="app-container sales-year">
    <div class="page-title">
      <!--标题栏-->
      <el-row :gutter="0">
        <el-col :span="23">
          <el-row type="flex" justify="center" align="middle">
            <span style="padding:0;" class="title">销售年报表</span>
          </el-row>
        </el-col>
        <el-col :span="1">
    ...
    <div class="term-search">
      ...
      <el-row :gutter="0" type="flex" justify="center">
        ...
        <el-col :span="6">
          <el-button size="small" type="danger" class="btn-search"  @click="saleStatYear">查询</el-button>
        </el-col>
        <el-col :span="11">
        </el-col>
      </el-row>
    ...
    <div class="table-contain padding">
      <el-table v-loading="loading" style="width: 100%;height:calc100%" height="100%"  :data="tableData"
        ...
        <el-table-column prop="statDate" label="月份" :formatter="formatterColumn"></el-table-column>
...
import { timeToDateFn, timeNow, yearFirstDay} from '@/utils/BbdCommon'
import { mapGetters } from 'vuex';
import { getSalesYearStatistic, fetchBrokerage, fetchDeport } from '@/api/reports'
export default {
  name: 'SalesYearStatistic',
  data () {
    return {
      loading: true,
      total: 0,
    ...
    handleSizeChange(val) {
      ...
      saleStatYear(){
        ...
        return new Promise((resolve, reject) => {
          getSalesYearStatistic(_self.requestData1).then(response => {
            // 总共的条数
      ...
      formatterColumn(row, column) {
        let arr = row.statDate.split('-').slice(0,2).join('-')
        return arr
      },
      // 设置默认时间
      getTime(){
...
.sales-year .el-loading-mask{
  z-index: 3;
}
.sales-year .is-scrolling-none {
